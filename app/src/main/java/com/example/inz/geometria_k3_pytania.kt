...
class geometria_k3_pytania : AppCompatActivity() {
    ...
    fun losowanie(){
        ...
        btnGeoQuizk3btn1.textSize=resources.getDimension(R.dimen.font_10sp)
        btnGeoQuizk3btn2.textSize=resources.getDimension(R.dimen.font_10sp)
        btnGeoQuizk3btn3.textSize=resources.getDimension(R.dimen.font_10sp)
        btnGeoQuizk3btn4.textSize=resources.getDimension(R.dimen.font_10sp)
        tvGeoQuizk3Question.textSize=resources.getDimension(R.dimen.font_14sp)
